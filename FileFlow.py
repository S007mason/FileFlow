...
from tkinter import *
#Creamos la ventana, dimensiones y título
ventana = tkinter.Tk()
ventana.geometry("500x400")
ventana.title("File Flow")

#Modo predetermindado de organización de archivos
def fun():
    ...
    for x in rutas_completas:
        ...
        # Aquí elimino la creación de una tupla para ruta2 y ruta3
...
#Función que alberga el modo personalizado
def carp():
    root = tkinter.Tk()
    root.title("")
    ...
    valor_interior = tkinter.StringVar(root)
    ...
    def cr():
        ...
        print(datos)
        aoa_datos=(aoa,datos)
        Labelee=tk.Label(ventana,text=aoa_datos).place(x=75,y=250,width=100, height=50)
    ...
    resultButton = tk.Button(root, text="Get Result", command=cr)
...
img_botton=tk.PhotoImage(file="C:/Users/iagoc/OneDrive/Escritorio/cosas2/app/icons8-carpeta-50.png")
Botón = tkinter.Button(image=img_botton,command=funcio,height=200, width=110, cursor="hand2" )
...
botonto=tk.Button(ventana,text="Añadir carpeta",command=carp,cursor ="hand2")
